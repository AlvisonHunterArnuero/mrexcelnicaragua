(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var cancelSync$1 = /*#__PURE__*/stepsOrder$1.reduce(function (acc, key) {
    ...
    var framesync = function (update) {
        ...
        return {
            start: function () {
                return sync$1.update(passTimestamp, true, true);
            },
            stop: function () {
                return cancelSync$1.update(passTimestamp);
            }
        };
    };
    function animate(_a) {
    ...
    var smooth = function (strength) {
        ...
        var lastUpdated = 0;
        return function (v) {
            var currentFramestamp = getFrameData$1().timestamp;
    ...
    var steps$2 = function (steps, direction) {
        if (direction === void 0) {
            direction = 'end';
        }
