...
function getAnimation(key, value, target, transition, onComplete) {
    ...
    function start() {
        ...
        return valueTransition.type === "inertia" ||
            ...
            ? easingLookup.inertia(tslib.__assign(tslib.__assign({}, options), valueTransition))
            : easingLookup.animate(getPopmotionAnimationOptions(valueTransition, options, key));
    }
    function set() {
        value.set(target);
        onComplete();
